...
sbatch eval/eval_vectorized.sh --config_path=submission/configs/eval_hm3d_config.yaml EXP_NAME new_eval_failed_eps PRINT_IMAGES 1 EVAL_VECTORIZED.specific_episodes 1 EVAL_VECTORIZED.record_videos 1
