...
#   --exp-name ddppo_train_custom_hm3d_annotated_scenes \
#   --command "python train/train_semantic_exploration_policy.py --config_path ddppo_train_custom_hm3d_annotated_scenes_dataset_config.yaml" \
#   --load-env "" \
#   --num-nodes 8 \
#   --num-gpus 8 \
#   --partition learnfair \
